...
<div class="body-wrapper">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                <li><a href="mailto:support@cthostel.com?Subject=TO%20the%20admin%20CTHostel"><i class="icon-mail"></i> support@cthostel.com</a></li>
           ...
           <div class="ltn__utilize-menu">
            ...
            <div class="ltn__utilize-buttons ltn__utilize-buttons-2">
                <ul>
                    ...
                    <li>
                        <a href="/serviceregistration" title="My Account">
                            <span class="utilize-btn-icon">
                                <i class="far fa-user"></i>
                            </span>
                    ...
                    <li>
                        <a href="/myroomie" title="Wishlist">
                            <span class="utilize-btn-icon">
                    ...
                    <li>
                        <a href="/egbami" title="Shoping Cart">
                            <span class="utilize-btn-icon">
                                <i class="fas fa-home"></i>
                    ...
                    <li>
                        <a href="/services" title="Shoping Cart">
                            <span class="utilize-btn-icon">
    ...
    <div class="ltn__slider-area ltn__slider-6">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1">
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item--- ltn__slide-item-9 section-bg-1 bg-image" data-bs-bg="{{ asset('myimages/cbanner.jpg')}}">
                            ...
                            <div class="slide-item-car-dealer-form">
                                ...
                                <div class="ltn__car-dealer-form-tab">
                                    <div class="ltn__tab-menu  text-uppercase text-center">
                                        <div class="nav">
                                            <a class="active show" data-bs-toggle="tab" href="#ltn__form_tab_1_1"><i class="fas fa-home"></i>Get Hostel</a>
                                            <a data-bs-toggle="tab" href="#ltn__form_tab_1_2" class=""><i class="fas fa-user"></i>Hire A Technician</a>
                                        </div>
                                    </div>
                                    <div class="tab-content pb-10">
                                        <div class="tab-pane fade active show" id="ltn__form_tab_1_1">
                                            <div class="car-dealer-form-inner">
                                                <form action="{{ route('cthome') }}" class="ltn__car-dealer-form-box row"> 
                                                   <!-- <div class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-home-2 col-lg-12 col-md-12">-->
                                                  ...
                                                  {{-- </div> --}}
                                                    ...
                                                    <div class="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-calendar col-lg-12 col-md-12">
                                                        <div class="btn-wrapper text-center mt-0">
                                                            <!-- <button type="submit" class="btn theme-btn-1 btn-effect-1 text-uppercase">Search Inventory</button> -->
                                                          <br>
                                                            <a href="/services" class="btn theme-btn-1 btn-effect-1 text-uppercase">Search</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2--- mb-20">
                            <h6 class="section-subtitle section-subtitle-2--- ltn__secondary-color">CTHOSTEL</h6>
                            <h1 id='about'class="section-title">A solution that matters...</h1>
                            <p>CT Hostel is a real estate technology brand that is focused on simplifying Nigeria tertiary 
                                student’s hostel acquisition process while prioritizing their comfortability and security through
                                the use of technology.<br><br>

                                We do this by connecting needy tertiary students with comfortable and affordable hostels in all 
                                tertiary institutions in Nigeria. We have a large 
                                number of agents, established real agencies and students registered on our platform and each 
                                agent and established real estate agencies have a webpage where they upload the pictures of 
                                their hostels and its specifications.<br><br>

<a href='/register' class='btn btn-success'>Be an agent!</a>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{ asset('welcomehome/img/bunk-bed.png')}}" width='20%' alt="#">
                         
                        </div>
                        <div class="ltn__feature-info">
                            <h3><a href="service-details.html">Hostel Accommodation</a></h3>
                            <p>We provide the best hostel accomodation service at a very affordable rate with no stress.</p>
                            <a class="ltn__service-btn" href="#home">Get a hostel <i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1 active">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{ asset('welcomehome/img/marketing.png')}}" width='20%' alt="#">
                            {{-- <i class="flaticon-user"></i> --}}
                        </div>
                        <div class="ltn__feature-info">
                            <h3><a href="service-details.html">Hostel Advertisement</a></h3>
                            <p>We give room for agents to showcase their respective hostels for annual rentage services free of charge.</p>
                            <a class="ltn__service-btn" href="/register">Advertise your hostel <i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{ asset('welcomehome/img/student.png')}}" width='20%' alt="#">
                        </div>
                        <div class="ltn__feature-info">
                            <h3><a href="service-details.html">Getting Roommates</a></h3>
                            <p>We provide a platform where students can get roomate based on their choices of department, gender, and other conditions.</p>
                            <a class="ltn__service-btn" href="/myroomie">Get A Roommate <i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="ltn__search-by-place-area before-bg-top bg-image-top--- pt-115 pb-70" data-bs-bg="img/bg/20.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center---">
                        <h6 class="section-subtitle section-subtitle-2--- ltn__secondary-color">An Innovation that prioritize student's security.</h6>
                        <h1 class="section-title">Do you know about the <br>
                            Egbami Of CTHostel?</h1>
                        <p>Egbami Of CTHostel is a platform developed to help student in an emergency situation, here is how it works...</p>
                    </div>
                </div>
            </div>
            <div class="row ltn__search-by-place-slider-1-active slick-arrow-1">
                    ...
                    <div class="ltn__search-by-place-item">
                        <div class="search-by-place-img">
                            {{-- <a href="product-details.html">
                                <img src="{{ asset('welcomehome/img/product-3/1.jpg')}}" alt="#">
                            </a> --}}
                        ...
                        <div class="search-by-place-info">
                           <span class="category-number" style='font-size:20px'>01</span>
                ...
                <div class="col-lg-4">
                    <div class="ltn__search-by-place-item">
                        <div class="search-by-place-img">
                            {{-- <a href="product-details.html"><img src="{{ asset('welcomehome/img/product-3/2.jpg')}}" alt="#"></a> --}}
                            <div class="search-by-place-badge">
                                <ul>
                                    {{-- <li>5 Properties</li> --}}
                                </ul>
                        ...
                        <div class="search-by-place-info">
                            <span class="category-number" style='font-size:20px'>02</span>
                            <h6>In any emergency situation, visit <a href='/egbami'>Egbami page</a> and input your emergency situation, this webpage will track your current location automatically and lastly,...</h6>
                            {{-- <h4><a href="product-details.html">Pacific Heights Area</a></h4> --}}
                            <div class="search-by-place-btn">
                                <a href="/egbami">Visit Page <i class="flaticon-right-arrow"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="ltn__search-by-place-item">
                        <div class="search-by-place-img">
                            {{-- <a href="product-details.html"><img src="{{ asset('welcomehome/img/product-3/3.jpg')}}" alt="#"></a> --}}
                            <div class="search-by-place-badge">
                                <ul>
                                    {{-- <li>9 Properties</li> --}}
                                </ul>
                        ...
                        <div class="search-by-place-info">
                            <span class="category-number" style='font-size:20px'>03</span>
                            <h6>Egbami of CThostel will then send a broadcast message to all student's around your location for help. <br>We also help contact ambulance, police, fire-fighter as the case may be, in the same instance.</h6>
                ...
                {{-- <div class="col-lg-4">
                    <div class="ltn__search-by-place-item">
                        ...
                        <div class="search-by-place-info">
                            <span class="category-number" style='font-size:20px'>04</span>
                            <h6>In a couple of seconds, you will see students, ambulance, police and everyone coming for your safety.<h6>
                            <div class="search-by-place-btn">
    ...
    <div class="ltn__category-area ltn__product-gutter section-bg-1--- pt-115 pb-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        <h6 class="section-subtitle section-subtitle-2--- ltn__secondary-color">Be an agent</h6>
                        <h1 class="section-title">Want to be an agent?<br>It's simple...</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                        <a href="/register">
                            ...
                            <span class="category-title">Registration</span>
                            <span class="category-brief">
                                To become an agent, you can register by providing your name, email address, phone number and your institution.
                            </span>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                        <a href="/register">
                            ...
                            <span class="category-title">Get Notified</span>
                            <span class="category-brief">
                               You will receive an email notification immediately, which contain your dashboard URL, and your personal webpage link.
                            </span>
                            <span class="category-btn d-none"><i class="flaticon-right-arrow"></i></span>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                        <a href="shop.html">
                            ...
                            <span class="category-title">Login To Your Dashboard</span>
                            <span class="category-brief">
                                You can then proceed to login to your dashboard where you will be able to post unlimited hostels
                            </span>
                            <span class="category-btn d-none"><i class="flaticon-right-arrow"></i></span>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                        <a href="shop.html">
                            ...
                            <span class="category-title">Post Hostels</span>
                            <span class="category-brief">
                              Post hostels with price, location, and description of hostels
                            </span>
                            <span class="category-btn d-none"><i class="flaticon-right-arrow"></i></span>
                        </a>
                    </div>
                ...
                {{-- <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                        <a href="shop.html">
                            ...
                            <span class="category-title">Webpage Link</span>
                            <span class="category-brief">
                                We automatically create a webpage link for you after registration, this is your personal customized website where customers can get to see and access your hostels
                            </span>
                            <span class="category-btn d-none"><i class="flaticon-right-arrow"></i></span>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                        <a href="shop.html">
                            ...
                            <span class="category-title">Close Hostel</span>
                            <span class="category-brief">
                               We help with advertisement of your hostels, and once any of your hostels is filled up, you can then close such hostels in your dashboard to prevent us from advertising an hostel that is no longer available.   
                            </span>
                            <span class="category-btn d-none"><i class="flaticon-right-arrow"></i></span>
                        </a>
                    </div>
    ...
    <div class="ltn__testimonial-area section-bg-1--- bg-image-top pt-115 pb-65" data-bs-bg="{{ asset('/welcomehome/img/bg/23.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center---">
                        <h6 class="section-subtitle section-subtitle-2--- ltn__secondary-color--- white-color">Testimonials</h6>
                        <h1 class="section-title white-color">See What Customer <br>
                            Says About Us</h1>
                    </div>
                </div>
            </div>
            <div class="row ltn__testimonial-slider-6-active slick-arrow-3">
                <div class="col-lg-4">
                            ...
                            <div class="ltn__testimoni-author-ratting">
                                <div class="ltn__testimoni-info-inner">
                                    <div class="ltn__testimoni-img">
                                        <img src="{{ asset('welcomehome/img/testimonial.png')}}" width='100%' alt="#">
                                    </div>
                                    <div class="ltn__testimoni-name-designation">
                                        <h5>Ibrowas Properties </h5>
                                        <label>Hostel Agents</label>
                                    </div>
                                </div>
                  ...
                  CTHostel is a very good platforms to advertise hostels, I was able to get my hostel filled up within a week after upload. I must commend the hostel advertisement strategy being used by CTHostel
                </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="ltn__testimoni-info">
                            <div class="ltn__testimoni-author-ratting">
                                <div class="ltn__testimoni-info-inner">
                                    ...
                                    <div class="ltn__testimoni-name-designation">
                                        <h5>Boluwatife Sotonwa</h5>
                                        <label>Student, COLANIM</label>
                                    </div>
                                </div>
                                <div class="ltn__testimoni-rating">
                                    <div class="product-ratting">
                 ...
                 I love the fact that I can filter hostels in accordance to the amount I have, and I will get to see all hostels at that price,which give me an opportunity to choose from wide range of options.
                </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="ltn__testimonial-item ltn__testimonial-item-7 ltn__testimonial-item-8">
                        <div class="ltn__testimoni-info">
                            ...
                            <p> I was able to get a roommate within 24 hours after getting my hostel from CTHostel.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="ltn__testimonial-item ltn__testimonial-item-7 ltn__testimonial-item-8">
                        <div class="ltn__testimoni-info">
                            ...
                            <p>I have been having insecurity issues before getting to know about CTHostel, Thank God for CTHostel, Infact I was able to see better hostels with the same price and resources</p>
                        </div>
                    </div>
                </div>
                <!--  -->
                ...
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg position-relative text-center---">
                        <div class="coll-to-info text-color-white">
                            ...
                            <p>Partner with us today and together we can make CTHostel bigger</p>
                        </div>
                        <div class="btn-wrapper">
                            <a class="btn btn-effect-3 btn-white" href="https://wa.me/2349058744473?text=Hi%2C%20my%20name%20is%20%28(Input%20your%20name)%0aI%20will%20like%20to%20partner%20with%20CTHostel%20Management.%0a(Input%20other%20message%20here)%20">Partner <i class="icon-next"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            <div class="footer-logo">
                                <div class="site-logo">
                                    <img src="{{ asset('myimages/logo_header.png')}}" style='width:150px;height:30px' alt="CTHostel">
                                </div>
                            </div>
                            {{-- <p>Lorem Ipsum is simply dummy text of the and typesetting industry. Lorem Ipsum is dummy text of the printing.</p> --}}
                            <div class="footer-address" id='contactus'>
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="tel:09058744473">+234 905 8744 473</a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-address-icon">
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="mailto:support@cthostel.com">support@cthostel.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-menu-widget clearfix">
                            ...
                            <div class="footer-menu">
                                <ul>
                                    <li><a href="/register">Agent Registration</a></li>
                                    <li><a href="/serviceregistration">Technician Registration</a></li>
                                    <li><a href="/egbamiregistration">Egbami Registration</a></li>
                                    <li><a href="order-tracking.html">Order tracking</a></li>
                                    <li><a href="/faq">FAQ</a></li>
                                    <li><a href="tel:09058744473">Contact us</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="ltn__copyright-design clearfix">
                            <p>All Rights Reserved @ CTHostel <span class="current-year"></span> Powered by <a href='https://thecaretech.org'>CareTech</a></p>
                        </div>
                    </div>
