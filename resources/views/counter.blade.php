...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="counterasset/css/vendor.css">
    <link rel="stylesheet" href="counterasset/css/styles.css">
...
<body id="top" class="theme-slides">
            ...
            <div class="row s-header__content">
                ...
                <div class="s-header__logo">
                    <a class="logo" href="index-slides.html">
                        <img src="myimages/logo_header.png" alt="Homepage">
                    </a>
                </div>
                ...
                <ul class="s-header__social">
                    ...
                    <li>
                        <a href="https://instagram.com/the_caretech?utm_medium=copy_link">
        ...
        <section id="intro" class="s-intro">
            ...
            <div class="s-intro__slider swiper-container">
                <div class="swiper-wrapper">
                    <div class="s-intro__slide swiper-slide bg-opacity-10" style="background-image: url(/myimages/CTH-bg.jpg);"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url(myimages/CTH-bg.jpg);"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url(myimages/CTH-bg.jpg);"></div>
                </div>
            </div>
            ...
            <div class="row s-intro__content">
                <div class="column lg-12">
                    ...
                    <div class="s-intro__content-bottom">
                        <h1 class="s-intro__content-title">CTHostel is launching soon for FUNAABITES usage.</h1>
                        <p>
                        Your number 1 platform for getting a reliable, trustable and affordable hostels. 
                        </p>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-about" class='tab-content__item'>
                            ...
                            <div class="row">
                                <div class="column">
                                    <p class="lead">
                                        CARETECH HOSTELS is an online platform where students across all tertiary institutions in Nigeria can secure a good and affordable hostels, we provide hostel according to each student's preferences in terms of price, location, structure, and resources availability.

                                    </p>
        
                                    <p>
                                        We also give room for agents, caretakers and landlords around the school premises to upload hostels easily for rentage purpose and we help in advertising the hostel free of charge
                                    </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="column lg-6 tab-12">
                                            ...
                                            <p>Get an indepth knowledge about how CTHostels works for students  </p>
                                            <a href="https://cthostel.com/faq" class="btn btn--primary u-fullwidth">Our FAQ</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="tab-services" class='tab-content__item'>
                            ...
                            <div class="row">
                                <div class="column">
                                    <p class="lead">
                                        Getting a comfortable, reliable and an affordable hostel is quite very easy and fun for students. These are the benefits of CTHostel to students. 
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                                ...
                                <div class="column services-list__item">
                                    ...
                                    <div class="services-list__item-content">
                                        <h4 class="item-title">Choose from 200+ hostels</h4>
                                        <p>
                                       We provide far enough hostels for students to make choices from in different locations, and different prices
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="column services-list__item">
                                    ...
                                    <div class="services-list__item-content">
                                        <h4 class="item-title">Make sure you are not getting overcharged.</h4>
                                        <p>
                                       CTHostels makes sure that every students get hostels at the cheapest amount possible, we achieve this by making a 12% off the price of all hostels on our platform
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="column services-list__item">
                                    ...
                                    <div class="services-list__item-content">
                                        <h4 class="item-title">Get a room mate of your choice</h4>
                                        <p>
                                       Incase you don't have the full money for getting an hostel, CTHostel provides you with an option to pair up with someone as a room mate.
                                       You get to choose room mate based on your decision of departments, level and religion.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="column services-list__item">
                                    ...
                                    <div class="services-list__item-content">
                                        <h4 class="item-title">Filter to your taste</h4>
                                        <p>
                                       We make sure there are hostels in all categories you can ever think of, you can filter hostels based on the location you want and the price range.
                                       Making sure you are not missing any good offer from us.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="column services-list__item">
                                    ...
                                    <div class="services-list__item-content">
                                        <h4 class="item-title">Get to know your hostel properly.</h4>
                                        <p>
                                        We don't just display the hostels for you, but we also make sure that we provide you with adequate details of each hostels and the resources availability.
                                        We show you the compound,the room, the toilets, the kitchen, and every other places. Infact using a laptop makes it easier to zoom at the range of 150% clear view.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="column services-list__item">
                                    ...
                                    <div class="services-list__item-content">
                                        <h4 class="item-title">Don't need to stress yourself if the hostel is filled or not</h4>
                                        <p>
                                        CTHostel save you the stress of getting to know if the hostel is filled up or not, as we only display hostels that are yet to be occupied for you.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div id="tab-contact" class="tab-content__item">
                            ...
                            <div class="row">
                                <div class="column">
                                    ...
                                    <p class="lead">
                                   To keep getting updates from us, please subscribe to our newsletter today.
                                    </p>
                ...
                <div class="column lg-6 stack-on-700 s-footer__block s-footer__contact">
                    ...
                    <div class="row">
                        <div class="column lg-6 stack-on-1000">
                            ...
                            <a href="tel:123-456-9000">+234 905 8744 473</a>
                            </p>
                        </div>
                        <div class="column lg-6 stack-on-1000">
                            <p>
                            <strong>Email</strong> <br>
                            <a href="mailto:#0">support@cthostel.com</a>
                            </p>
                        </div>
                    </div>
            ...
            <div class="row s-footer__bottom">
                <div class="column lg-12">
                    <div class="ss-copyright">
                        <span>© Copyright CTHostel 2021</span> 
    ...
    <!-- Java Script
    ================================================== -->
    <script src="counterasset/js/plugins.js"></script>
    <script src="counterasset/js/main.js"></script>
    <script src="counterasset/js/particles.min.js"></script>
    <script src="counterasset/js/particle-settings.js"></script>
