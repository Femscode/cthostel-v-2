                        ...
                        <div class="card mb-12">
								...
								<div class="modal-dialog modal-dialog-centered mw-750px">
									...
									<div class="modal-content rounded">
										...
										<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
											<!--begin:Form-->
											<form  method='post' class="form" action="{{route('sugagentmail')}}" enctype='multipart/form-data'>@csrf
												<!--begin::Heading-->
												<div class="mb-13 text-center">
													<!--begin::Title-->
													<h1 class="mb-3">Send Bulk Email Message To Students</h1>
													<!--end::Title-->
													<!--begin::Description
							...
							<div class="modal fade" id="kt_modal_new_ticket2" tabindex="-1" aria-hidden="true">
								...
								<!--end::Modal dialog-->
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_ticket" class="btn btn-primary fw-bolder fs-8 fs-lg-base">Message Students</a>
                                            ...
                                            <div class="g-5 gx-xxl-8">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-header border-0 pt-5">
                                                        <h4>Student Complains about hostels</h4>
