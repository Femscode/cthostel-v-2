...
https://hostel.thecaretech.org/hostel/web/images/alternative.jpeg-->
	<div id="block" data-vide-bg="https://hostel.thecaretech.org/hostel/web/video/alternative2.jpeg" height='5000px' style='height:5000px;width:100%' data-vide-options="position: 0% 50%">
			<div class="overlay">
              <h2>{{$school[0]->name}}<span style='color:white'> Hostels</span><br>
...
<section class="divider-wthree" >
	<div class="container">
		<h3 class="text-center" style='color:black' data-aos="zoom-in">Filter hostel<br>
				<a href='{{Route("allhostel",[$school_id])}}' style='text-align:center'><button class='btn btn-primary'>All Hostels</button></a>
          				<a onclick='showFilter()' style='text-align:center'><button id='toggleFilter' class='btn btn-success'>Filter Hostels</button></a>
...
function showFilter() {
  ...
  if(show.style.display === 'none') {
    ...
    toggle.innerText = 'Hide Filter';
  } else {
    show.style.display = 'none';
    toggle.innerText = "Filter Hostel";
  }
}
</script>
  <script>
