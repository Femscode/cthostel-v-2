...
<body
  style='background:url("/myimages/CTH-Egbami.png");background-repeat:no-repeat;background-size:cover; background-position:center;width:100%'>
  <!--
<body style='background:url("/myimages/egbami.png")' class="">
-->
  ...
  <div class="site-wrapper">
    ...
    <div id="bottom" class="bottom top-row">
      <div class="grid-rows">
        ...
        <div class="grid-row grid-row-bottom-5" style='background:url("/myimages/.jpeg")'>
          <div class="grid-cols">
                ...
                <div class="grid-item grid-item-bottom-5-1-1">
                  <div class="module title-module module-title-163">
                    <div class="title-wrapper">
                      <div id='egbamishow' style='display:none;color: #155724;background-color: #d4edda;border-color: #c3e6cb;position: relative;
    padding: .75rem 1.25rem;
    margin-bottom: 1rem;
    border: 1px solid transparent;
    border-radius: .25rem;'>
                        Message Sent To All Students Closer To Your Location Successfully!
                      </div>


                      <h2 style='color:#089A49;text-shadow:1px 1px black'>ÈGBÀMÍ OF CTHOSTEL</h2><br>
                      <div id='egbami'>
                      </div>
                      <br>
                      <h5 style='font-size:22px' id='areyou'>Are you in a state of emergency? You can reach out to us.
                      </h5>
                      <div class="title-divider"></div>
                      <div class="subtitle">
                        <form method="POST" id='egbamiform'>
                          @csrf
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-12">
                              ...
                              <input type='text' required id="message" type="text" class="form-control" name="message"
                                value="{{ old('email') }}"
                                placeholder='Type your emergency case, we will then take it up from there' required
                                autocomplete="email" autofocus>

                              <button id='egbamibutton' type="submit" class="btn btn-primary">
                                Go!
                              </button>
                            </div>
                          </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <p>Message has been sent to all students closer to you, to be more specific, please fill the form below</p>


        </div>
        <div class="modal-body">
          <form id='additional_info'>@csrf
            <div class="form-group">
              <label for="formGroupExampleInput">Hostel Name</label><br>
              <textarea rows='2' type="text" name='hostel_name' id='hostel_name' class="form-control"
                placeholder='Specify hostel name'></textarea>
            </div>
            <div class="form-group">
    ...
    <div class="module module-notification module-notification-137 notification"
      ...
      <div class="notification-content">
        <div>
          ...
          <div class="notification-text">Please note that we only need your emergency message, this page will
            automatically track your current location and send to every students closer to you that can be of help
            Thanks.</div>
        </div>
      </div>
    </div>
 ...
 // alert("My public IP address is: " + json.ip);
    ...
    $(document).ready(function() {
          ...
          $.ajaxSetup({
              headers: {
     		   ...
     		   $("#egbamiform").submit(async function(e) {
                       e.preventDefault()
                            //  $("#egbamibutton").attr('disabled',true);
         ...
         console.log(fd, 'this is the fd');
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "{{route('egbamirequest')}}",
                                data: fd,
                                cache: false,
                                contentType: false,
                                processData: false,
                                success: (data) => {
                                  swal("Success", 'Message has been sent to all students that can be of assit to you', 'success');
                             console.log(data)
				                        },
                                error: function(data) {
                                  $('#exampleModalCenter').modal('show'); 
                                    ...
                                    console.log(data);
                                  $("#egbamishow").hide()
                                    swal('Oops', 'If you see this, it means your request is not received, please make use of the emergency button at the left top immediately','error')
                                }
                            });
			});
  ...
  <script>
    $('body').on('submit','#additional_info',async function(e) {
     e.preventDefault()
    var fd = new FormData();

// Append data 
fd.append('hostel_name', $("#hostel_name").val());
...
$.ajax({  
    ...
    error: (data) => {
      console.log(data);
      swal('error','Opps something is wrong','error')
    }
   });
   });
  </script>
