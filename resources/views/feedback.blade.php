                            ...
                            <div class="card-body flex-column p-5">
                                ...
                                <div class="d-flex align-items-center h-lg-300px p-5 p-lg-15">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <h1 class="fw-bolder fs-4 fs-lg-1 text-gray-800 mb-5 mb-lg-10">Have a comment, feedback or complaint on any hostel?</h1>
                                        <!--end::Title-->
                                        <!--begin::Input group-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-10 p-lg-15">
                                ...
                                <div class="mb-13">
                                    ...
                                    <div class="mb-15">
                                        <!--begin::Title-->
                                        <h4 class="fs-2x text-gray-800 w-bolder mb-6">Drop your complaints</h4>
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <a class='btn btn-success' data-bs-toggle="modal" data-bs-target="#kt_modal_new_address">Make Complaint</a>
                                        <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    <!--begin::Form-->
                                                    <form method='post' id='add_complaint' enctype="multipart/form-data">@csrf
                                                        <!--begin::Modal header-->
                                                        ...
                                                        <div class="modal-body py-10 px-lg-17">
                                                            ...
                                                            <div class="scroll-y me-n7 pe-7"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex flex-stack flex-grow-1">
                                                                        ...
                                                                        <div class="fw-bold">
                                                                            ...
                                                                            <div class="fs-6 text-gray-700">Please make sure that this complaint is real and genuine because adequate measures will be taken upon all complaint.
                                                                                <a href="#"></a>
                                                                            </div>
                                                                        </div>
                                                                        <!--end::Content-->
                                                                ...
                                                                <div class="d-flex flex-column mb-5 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="required fs-5 fw-bold mb-2">Hostel Name</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input required class="form-control form-control-solid" id='hostel_name'
                                                                ...
                                                                <div class="d-flex flex-column mb-5 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required fs-5 fw-bold mb-2">Complaint
                                                                        </label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <textarea cols='5' rows='5' required class="form-control form-control-solid"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="w-100 d-flex flex-stack mb-8">
                                                        ...
                                                        <div class="d-flex align-items-center f">
                                                            <!--begin::Author-->
                                                            <div class="symbol symbol-50px me-5">
                                                                <div class="symbol-label fs-1 fw-bolder bg-light-success text-success">{{Str::limit($feedback->name,2)}}</div>
                                                            </div>
                                                            <!--end::Author-->
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column fw-bold fs-5 text-gray-600 text-dark">
                                                                ...
                                                                <!--end::Text-->
                                                                <!--begin::Date-->
                                                                <span class="text-muted fw-bold fs-6">{{$feedback->created_at->toDayDateTimeString()}}</span>
                                                                {{-- <span class="text-muted fw-bold fs-6">{{$feedback->created_at->diff(\Carbon\Carbon::now())->days}} days ago</span> --}}
...
<script src="{{ asset('assets2/js/custom/intro.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
				   ...
				   $("#add_complaint").submit(async function(e) {
                            e.preventDefault();
                            ...
                            $.ajax({
                                ...
                                error: function(data) {
                                    console.log(data);
                                    swal('Oops', 'Complaint not submitted','error')
                                }
                            });
						});
