...
<head>
    <title>CTHostel | SuperAdmin</title>
    ...
    <meta property="og:site_name" content="CTHostel | SuperAdmin" />
...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
                                ...
                                <div class="d-flex align-items-center h-lg-300px p-5 p-lg-15">
                                    ...
                                    <ul class="nav flex-wrap border-transparent fw-bolder">
                                        ...
                                        <li class="nav-item my-1">
                                            <a class="btn btn-color-gray-600 btn-active-white btn-active-color-primary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" >Student Complains</a>
                                        </li>
                                        <!--end::Nav item-->
                                        <!--begin::Nav item-->
                                        <li class="nav-item my-1">
                                        ...
                                        <!--begin::Nav item-->
                                        <li class="nav-item my-1">
                                            <a class="btn btn-color-gray-600 btn-active-white btn-active-color-primary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="/hostels">All Hostels</a>
                                        </li>
                                        <!--end::Nav item-->
                                        <!--begin::Nav item-->
                                        <li class="nav-item my-1">
                                        ...
                                        <li class="nav-item my-1">
                                                 <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_ticket2" class="btn btn-success fw-bolder fs-8 fs-lg-base">Message Agents</a>
                           				</li>
                                        <!--end::Nav item-->
                                        <!--end::Nav item-->
                                    </ul>
								...
								<div class="card">
									...
									<div class="card-header border-0 pt-5">
										...
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bolder fs-3 mb-1">Link Counter</span>
										</h3>
    	...
    	<!--begin::Table head-->
												<thead>
													<tr class="border-0">
														...
														<th class="p-0">Clicks</th>
														<th class="p-0">Type</th>
														<th class="p-0">Message</th>
														<th class="p-0">Call</th>
														<th class="p-0">Upgrade</th>
                                                ...
                                                @foreach($users as $user)
													<tr>
														...
														<td>
															...
															<a onclick='return confirm("Are you sure you want to upgrade this agent?")' href='/upgrade_user/{{ $user->id }}' class='btn btn-sm btn-warning'>Upgrade</a>
															@else
															<a onclick='return confirm("Are you sure you want to degrade this agent?")' href='/degrade_user/{{ $user->id }}' class='btn btn-sm btn-danger'>Degrade</a>
															@endif
														</td>
														<td>
															<form method='post' action='{{ route("set_rank",["id" => $user->id]) }}'>@csrf
																<input required type='number' value='{{ $user->rank ?? "" }}'name='rank' class='form-control'>
							...
							<div class="g-5 gx-xxl-8">
								...
								<div class="card">
									...
									<div class="card-header border-0 pt-5">
										...
										<div class="card-toolbar">
											<a class='btn btn-primary btn-sm' href='/createschool'>Create School</a>
											<a class='btn btn-info btn-sm' href='/createlocation'>Create Location</a>
										</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
											...
											<table id='datatable' class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
												...
												<thead>
													<tr class="border-0">
														...
														<th class="p-0 min-w-150px">S/N</th>
														<th class="p-0 min-w-200px">Name</th>
														<th class="p-0 min-w-200px">Action</th>
															</tr>
												</thead>
												<!--end::Table head-->
												<!--begin::Table body-->
												<tbody>
                                                @foreach($schools as $key => $user)
													<tr>
														<td>{{++$key}}</td>
														<td>{{$user->name}}</td>
                                                        <td><a id='editschool' class='btn btn-primary'>Edit</a></td>
                                                        <td><a id='deleteschool' class='btn btn-danger'>Delete</a></td>
		...
		<div class="modal fade" id="kt_modal_create_app" tabindex="-1" aria-hidden="true">
			...
			<div class="modal fade" id="kt_modal_new_ticket2" tabindex="-1" aria-hidden="true">
								<!--begin::Modal dialog-->
								<div class="modal-dialog modal-dialog-centered mw-750px">
									...
									<div class="modal-content rounded">
										...
										<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
											<!--begin:Form-->
											<form  method='post' class="form" action="{{route('sugstudentmail')}}" enctype='multipart/form-data'>@csrf
												<!--begin::Heading-->
												<div class="mb-13 text-center">
													<!--begin::Title-->
													<h1 class="mb-3">Send Bulk Email Message To Agents</h1>
													<!--end::Title-->
													<!--begin::Description
												...
												<div class="d-flex flex-column mb-8 fv-row">
													...
													<label class="d-flex align-items-center fs-6 fw-bold mb-2">
														...
														<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Mail Subject"></i>
													</label>
													<!--end::Label-->
													<input type="text" class="form-control form-control-solid" placeholder="Enter Mail Subject" name="subject" />
												</div>
												<div class="d-flex flex-column mb-8 fv-row">
													<!--begin::Label-->
													<label class="d-flex align-items-center fs-6 fw-bold mb-2">
														<span class="required">Header</span>
														<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Mail Subject"></i>
													</label>
													<!--end::Label-->
													<input type="text" class="form-control form-control-solid" placeholder="Enter Mail header" name="header" />
												</div>
												<!--end::Input group-->
												<!--begin::Input group-->
												<div class="d-flex flex-column mb-8 fv-row">
													<label class="fs-6 fw-bold mb-2">Message Details</label>
													<textarea class="form-control form-control-solid" rows="4" name="message" placeholder="Type Message"></textarea>
												</div>
												<!--end::Input group-->
												<!--begin::Input group-->
												...
												<div class="text-center">
													...
													<button type="submit" id="kt_modal_new_ticket_submit" class="btn btn-primary">
														<span class="indicator-label">Send Mail</span>
														<span class="indicator-progress">Please wait... 
														<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
													</button>
												</div>
