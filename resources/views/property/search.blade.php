                      ...
                      <div class="module-item module-item-1 info-blocks info-blocks-icon">
                        <div class="info-block">
                          <div class="info-block-content">
                            <div class="info-block-title">Hostels based on your search</div>
                      ...
                      <div class="tab-container">
                        <ul class="nav nav-tabs">
                          <li class="tab-1 active">
                            <a href="#products-61181fcd4109f-tab-1" data-toggle="tab">Searched Properties</a>
                          </li>
                          {{-- <li class="tab-2">
                                ...
                                <div class="product-thumb">
                                  <div class="image">
                                    ...
                                    <a href="{{route('cthostel',[$album->slug,$album->id])}}"
                                      ...
                                      <div>
                                        <img
                                        src="{{asset('propertyimage/'.$album->image)}}"
                                        data-src="{{asset('propertyimage/'.$album->image)}}"
                                        data-srcset="{{asset('propertyimage/'.$album->image)}}"
                                  ...
                                  <div class="caption">
                                    ...
                                    <div class="name"><a href="{{route('cthostel',[$album->slug,$album->id])}}" style='background:#003544;color:white;border-radius:4px' class='btn btn-success'>View Property</a></div>
                ...
                <div class="grid-item grid-item-bottom-5-1-1">
                  <div class="module title-module module-title-163">
                    <div class="title-wrapper">
                      ...
                      <div class="subtitle">Filter Properties based on price and type.</div>
                    </div>
                  </div>
