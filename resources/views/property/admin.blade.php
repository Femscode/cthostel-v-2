                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <a href="/{{Auth::user()->username}}"
                                                        class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3">cthostel.com/{{Auth::user()->username}}</a>
                                                </div>
                                                <!--end::Name-->
                                                <!--begin::Info-->
                            ...
                            <div class="card-body pt-3">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="modal fade" id="kt_modal_create_api_key" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <!--end::Modal header-->
                                                        <!--begin::Form-->
																<form id="kt_modal_create_api_key_form" class="form" enctype="multipart/form-data" action="#">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex flex-stack flex-grow-1">
                                                                            ...
                                                                            <div class="fw-bold">
                                                                                <h4 class="text-gray-900 fw-bolder">
                                                                                    Please Note!</h4>
                                                                                <div class="fs-6 text-gray-700">It is
                                                                                    advisable to upload three(3) images
                                            ...
                                            <td>
                                                <a title='Edit Hostel' href="#" data-id='{{ $album->id }}'
                                                    ...
                                                    {{-- <a href='{{Route("edit.album",[$album->id])}}'
                                                        class="btn btn-icon btn-bg-light btn-color-primary btn-sm me-1">
                                                        --}}
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24px"
                                ...
                                <td>
                                    <label
                                        ...
                                        <input title='Hostel Availability' class="status_id form-check-input"
                                            data-id='{{$album->id}}' name="github" type="checkbox" value="1"
                                            @if($album->status == 1)checked='checked'@else
                                        @endif>
                                ...
                                <td>
                                    <a title='Set Hostel Geolocation Address' class='fa fa-map-marker fa-2x'
                                        href='{{route("address",[$album->id])}}'>

                                    </a>
                                </td>
                                <td>
                                    {{-- <form action="{{ Route('destroy.album', [$album->id]) }}" --}} <form
                                        id='delete_hostel' data-id="{{$album->id}}"
    ...
    <script>
        $(document).ready(function() {
				   ...
				   $("#create_hostel_form").submit(async function(e) {
                       e.preventDefault()
                       swal('Creating hostel, please wait...')
                            ...
                            $.ajax({
                                ...
                                error: function(data) {
                                    console.log(data);
                                    swal.close()
                                    swal('Oops', 'Hostel not created','error')
                                }
                            });
						});
                ...
                e.preventDefault();
                swal('Updating hostel, please wait...');
        ...
        console.log(files,'the files');
			...
			$("#kt_modal_create_api_key_form").on('submit', async function(e){
                e.preventDefault();
                swal('Uploading Additional Images, Please Wait...')
				...
				var id = $("#hostelimage").val();
                            ...
                            $.ajax({
                                ...
                                processData: false,
                                success: (data) => {
                                    swal("Success", 'Hostel Addtional Images Uploaded successfully', 'success');
