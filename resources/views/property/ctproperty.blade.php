...
<body class="">
  ...
  <div class="site-wrapper">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="index7c5b.html?route=product/category&amp;path=111&amp;limit=100">{{$album->school->name}}</a>
          ...
          <div class="product-info has-extra-button ">
                  ...
                  <div class="swiper-container">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide" data-gallery=".lightgallery-product-images" data-index="0">
                        <img src="{{asset('public/propertyimage/'.$album->image)}}"
                          srcset="{{asset('public/propertyimage/'.$album->image)}}" data-largeimg="{{$album->image}}"
                      ...
                      <div class="swiper-slide" data-gallery=".lightgallery-product-images" data-index="1">
                        <img src="{{asset('public/propertyimage/'.$album->image)}}"
                          srcset="{{asset('public/propertyimage/'.$album->image)}}"
                          data-largeimg="{{asset('public/propertyimage/'.$album->image)}}" alt="CTHostel" title="CTHostel"
            ...
            <div class="product-left">
                  ...
                  <div class="swiper-container">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide" data-gallery=".lightgallery-product-images" data-index="0">
                        <img src="{{asset('public/propertyimage/'.$album->image)}}"
                          srcset="{{asset('public/propertyimage/'.$album->image)}}"
                          data-largeimg="{{asset('public/propertyimage/'.$album->image)}}" alt="{{$album->name}}"
                ...
                <div class="swiper additional-images"
                  ...
                  <div class="swiper-container">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide additional-image" data-index="0">
                        <img src="{{asset('public/propertyimage/'.$album->image)}}"
                          srcset="{{asset('public/propertyimage/'.$album->image)}}" alt="hostel" title="hostel" width="80"
                          height="80" />
                      </div>
              ...
              <div class="lightgallery lightgallery-product-images" data-images='[
                  {&quot;src&quot;:&quot;{{asset(' public/propertyimage/'.$album->
                image)}}&quot;,&quot;thumb&quot;:&quot;{{asset('public/propertyimage/'.$album->image)}}&quot;,&quot;subHtml&quot;:&quot;&quot;},
                @foreach($album->albumimages as $key => $img)
                ...
                <div class="product-blocks blocks-top">
                  ...
                  <div class="product-stats">
                    <ul class="list-unstyled">
                      <li class="product-stock in-stock"><b>Location:</b> <span>{{$album->school->name}}</span></li>
                      <li class="product-model"><b>Agent:</b> <span>{{$album->user->name}}</span></li>
                    </ul>

                    <div class="custom-stats">
                      <div class="product-sold"><b>Among the top 20 Best Properties</b></div>
                    </div>
                  </div>
                          ...
                          <div class="grid-items">
                            <div class="grid-item grid-item-251-1-1-1">
                              <div class="module module-button module-button-252">
                                <!--                 <a style='background:#007bff' class="btn btn-success" href='https://wa.me/234{{substr($album->user->phone,1)}}?text=Hi%2C%20my%20name%20is%20%28Input%20your%20name%29.%0aHOSTEL%20REQUEST%20FOR%20CTHOSTEL.%0aInstitution:{{$album->school->name}}%0aHostel%20name:%20({{$album->name}})%0aHostel%20Price:{{$album->price}}%0aLocation:{{$album->school->name}}%0aAgent%20in%20charge:{{$album->user->name}}%0a(Input%20other%20message%20here)%20'>Message Agent In Charge >>></a>-->
                                <a style='background:#007bff' class="btn btn-success"
                                  href="{{route('counter',[$album->id])}}">Message Person In Charge >>></a>
                  ...
                  <div class="module module-products module-products-271 module-products-grid carousel-mode">
                    <div class="module-body">
                      <div class="module-item module-item-1 swiper-slide">
                        <h3 class="title module-title">Similar Properties</h3>
                        <div class="swiper"
                                  ...
                                  <div class="image">
                                    <div class="quickview-button">
                                      <a href="{{route('cthostel',[$album->slug,$album->id])}}"
                                        ...
                                        data-tooltip-class="{{asset('public/propertyimage/'.$album->image)}}"
                                        data-placement="top" title="Quickview"
                                        onclick="{{asset('public/propertyimage/'.$album->image)}}"><span
                                    ...
                                    <a class="product-img has-second-image">
                                      <div>
                                        <img src="{{asset('public/propertyimage/'.$album->image)}}"
                                          ...
                                          data-srcset="{{asset('public/propertyimage/'.$album->image)}}" width="250"
                                          height="250" alt="Black High Heels" title="Black High Heels"
                                        ...
                                        <div class="cart-group">
                                          ...
                                          <a class="btn btn-cart" href="{{route('cthostel',[$album->slug,$album->id])}}"
                                            data-loading-text="<span class='btn-text'>Add to Cart</span>"><span
                                              class="btn-text">View Property</span></a>
                                        </div>
              ...
              <div class="grid-items">
                <div class="grid-item grid-item-bottom-1-2-1">
                  <div class="module module-products module-products-272 module-products-grid carousel-mode">
                    <div class="module-body">
                      <div class="module-item module-item-1 swiper-slide">
                        <h3 class="title module-title">Other Properties from {{$album->user->name}}</h3>
                        <div class="swiper"
                          data-items-per-row='{"c0":{"0":{"items":3,"spacing":20},"760":{"items":2,"spacing":10}},"c1":{"0":{"items":4,"spacing":20},"760":{"items":2,"spacing":10}},"c2":{"0":{"items":3,"spacing":20}},"sc":{"0":{"items":1,"spacing":20}}}'
                          data-options='{"speed":500,"autoplay":false,"pauseOnHover":true,"loop":false}'>
                          <div class="swiper-container">
                                    ...
                                    <a href="{{route("cthostel",[$album->slug,$album->id])}}" class="product-img
                                      ...
                                      <div>
                                        <img src="{{asset('public/propertyimage/'.$album->image)}}"
                                          data-src="{{asset('public/propertyimage/'.$album->image)}}"
                                          data-srcset="{{asset('public/propertyimage/'.$album->image)}}" width="250"
                                          height="250" alt="Hostel Image " title="Hostel Image "
                                          class="img-responsive img-first lazyload" />
                  ...
                  <div class="grid-items">
                    <div class="grid-item grid-item-1">
                      <div class="module module-newsletter module-newsletter-113">
                        <h3 class="title module-title">Heard of CT_Taste?</h3>
                        <div class="module-body">
                          <div class="newsletter-text">With CT_taste, you can now order for your favourite meals from
                            your top food plugs in a very easy way.
                    ...
                    <div class="grid-item grid-item-2">
                         <a class='btn btn-success' href='https://cttaste.com' target="_blank">Order Now</a>
