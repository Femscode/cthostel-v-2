                ...
                <div class="header-search">
                  <div style='background:red;animation:1s infinite example;animation-duration: 1s infinite;'
                    ...
                    <div class="dropdown-menu j-dropdown">
                      ...
                      <form method='post' action='{{route("search_property")}}'>@csrf
            ...
            <ul class="j-menu">
              <li class="menu-item main-menu-item main-menu-item-1 dropdown flyout drop-menu ">
                <a class="dropdown-toggle" data-toggle="dropdown">
                  <span class="links-text">Available Properties</span>
                  ...
                  <div id="flyout-menu-611817a64dfd2" class="flyout-menu flyout-menu-7">
                    <ul class="j-menu">
                      <li class="menu-item flyout-menu-item flyout-menu-item-6 multi-level ">
                        <a href="#">
                          <span class="links-text">Furnitures</span>
                        ...
                        <a href="#">
                          <span class="links-text">Kitchen Materials</span>
                          <span class="menu-label">New</span>
                        </a>
                        <a href="#">
                              ...
                              <div class="swiper-wrapper">
                                <div class="module-item module-item-1 swiper-slide">
                                  <div class="block-body">
                                    ...
                                    <div class="block-content block-text">
                                      Caretech hostel is a very good platforms to advertise hostels, I was able to get
                                      my hostel filled up within a week after upload. I am so grateful for having
                                      Caretech Hostel
                                    </div>
                                    <div class="block-footer">- Sotonwa Boluwatife</div>
                                  </div>
                                ...
                                <div class="module-item module-item-2 swiper-slide">
                                  <div class="block-body">
                                    ...
                                    <div class="block-content block-text">
                                      ...
                                      I love the fact that I can filter hostels in accordance to the amount I have, and
                                      I will get to see all hostels at that price,which give me an opportunity to choose
                                      from wide range of options.
                                    </div>
                                    <div class="block-footer">- Adebanjo Adedamola</div>
                                  </div>
                                ...
                                <div class="module-item module-item-3 swiper-slide">
                                  <div class="block-body">
                                    ...
                                    <div class="block-content block-text">
                                      ...
                                      .</div>
                                    <div class="block-footer">- Soleye Alexander</div>
                                  </div>
                                ...
                                <div class="module-item module-item-4 swiper-slide">
                                  <div class="block-body">
                                    <div class="block-header"><i class="icon icon-block"></i></div>
                                    <div class="block-content block-text">
                                      I was able to get a very good hostel within a short period of time at a very cheap
                                      price
                                      !</div>
                                    <div class="block-footer">- Ogundele Samson</div>
                                  </div>
                                ...
                                <div class="module-item module-item-5 swiper-slide">
                                  <div class="block-body">
                                    <div class="block-header"><i class="icon icon-block"></i></div>
                                    <div class="block-content block-text">Amazing ways to customize so you don't end up
                                      with a site looking like everyone else's :) Unique sites are much better than
                                      clone sites, as they keep the customers interest and the bounce rate is a lot
                    ...
                    <div class="grid-items">
                      <div class="grid-item grid-item-content-top-1-2-1">
                        <div class="module module-master_slider module-master_slider-232"
                          ...
                          <img data-src="/myimages/silder_03.jpg" srcset="myimages/slider_03.jpg" alt="" width="880"
                            height="440" />
                          ...
                          <div class="master-slider ms-skin-minimal"
                            ...
                            <div class="module-item module-item-1 ms-slide">
                              <img class='lazyload' data-src="/myimages/slider_02.jpg" src="/myimages/slider_02.jpg"
                                srcset="myimages/slider_02.jpg" alt="" width="880" height="440" />
                            ...
                            <div class="module-item module-item-2 ms-slide">
                              <img data-src="/myimages/slider_01.jpg" src="/myimages/slider_01.jpg"
                                srcset="myimages/slider_01.jpg" alt="" width="880" height="440" />
                              ...
                              <div style='color:#033553'
                                ...
                                data-ease="easeOutQuart" data-hide-effect="fade" data-hide-delay="0"
                                data-hide-duration="0">Get cheap and quality hostel properties with no stress</div>
                              <div class="module-subitem module-subitem-2 ms-layer ms-layer-text ms-caption"
                                data-resize="true" data-origin="ml" data-parallax="0" data-type="text"
                            ...
                            <div class="module-item module-item-3 ms-slide" data-delay="2.5">
                              <img data-src="/myimages/slider_03.jpg" src="/myimages/slider_03.jpg"
                                srcset="myimages/slider_03.jpg" alt="" width="880" height="440" />
                              ...
                              <div class="module-subitem module-subitem-1 ms-layer ms-layer-text ms-caption"
                                ...
                                data-effect="skewright(60,200)" data-delay="" data-duration="500"
                                data-ease="easeOutQuart" data-hide-effect="fade" data-hide-delay="0"
                                data-hide-duration="0">Don't get scammed, get it here!</div>
                              <div class="module-subitem module-subitem-2 ms-layer ms-layer-text ms-caption"
                                data-resize="true" data-origin="ml" data-parallax="0" data-type="text"
                                data-position="normal" data-offset-x="30" data-offset-y="20"
                                data-effect="skewright(60,200)" data-delay="" data-duration="500"
                  ...
                  <div class="grid-col grid-col-content-top-1-3">
                    <div class="grid-items">
                      <div class="grid-item grid-item-content-top-1-3-1">
                        <div id="banners-61181fcd29534" class="module module-banners module-banners-132">
                          <div class="module-body">
                            ...
                            <div class="module-item module-item-3 info-blocks info-blocks-icon">
                              <div class="info-block">
                                <div class="info-block-content">
                                  ...
                                  <div class="info-block-text">Make an agreement with the agents, check the hostels out
                                    and start living comfortably.</div>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="grid-items">
                    <div class="grid-item grid-item-column-right-1-2-1">
                      <div class="module module-newsletter module-newsletter-196">
                        <h3 class="title module-title">Wants to be a vendor?</h3>
                        <div class="module-body">
                          <div class="newsletter-text">Register here to become a vendor.</div>

                          <a class='btn btn-success' href='register'>Be a vendor</a>
                  ...
                  <div class="grid-items">
                    <div class="grid-item grid-item-column-right-1-2-1">
                      <div class="module module-newsletter module-newsletter-196">
                        ...
                        <div class="module-body">
                          <div class="newsletter-text">Input your email to receive latest updates from us.</div>
                  ...
                  <div class="module module-info_blocks module-info_blocks-260">
                    <div class="module-body">
                      <div class="module-item module-item-1 info-blocks info-blocks-icon">
                        <div class="info-block">
                          <div class="info-block-content">
                            <div id='latesthostel' class="info-block-title">Our latest properties</div>
                      ...
                      <div class="tab-container">
                        <ul class="nav nav-tabs">
                          <li class="tab-1 active">
                            <a href="#products-61181fcd4109f-tab-1" data-toggle="tab">Furnitures</a>
                          </li>
                          <li class="tab-2">
                            <a href="#products-61181fcd4109f-tab-2" data-toggle="tab">Electronics</a>
                          </li>
                          <li class="tab-3">
                            <a href="#products-61181fcd4109f-tab-3" data-toggle="tab">Kitchen Utensils</a>
                          </li>
                          <li class="tab-4">
                            <a href="#products-61181fcd4109f-tab-4" data-toggle="tab">Decorations</a>
                          </li>
                          <li class='tab-5'>
                            <a href="#products-61181fcd4109f-tab-5" data-toggle="tab">Special Request</a>
                          </li>
                        </ul>
                        <div class="tab-content">
                          <div class="module-item module-item-1 tab-pane active" id="products-61181fcd4109f-tab-1">
                            <div class="product-grid" id='table_data'>
                              @include('property.furnitures')
                            </div>
                          </div>
                          <div class="module-item module-item-2 tab-pane" id="products-61181fcd4109f-tab-2">
                            <div class="product-grid">
                              @include('property.electronics')
                            </div>

                          </div>
                          <div class="module-item module-item-3 tab-pane" id="products-61181fcd4109f-tab-3">
                            <div class="product-grid">
                              @include('property.kitchen')
                            </div>

                          </div>
                          <div class="module-item module-item-4 tab-pane" id="products-61181fcd4109f-tab-4">
                            <div class="product-grid">
                              @include('property.decorations')
                            </div>
                          </div>
                          <div class="module-item module-item-5 tab-pane" id="products-61181fcd4109f-tab-5">
                            <div class="product-grid">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Make Special Request</h5>
                                  ...
                                  <div class="modal-body">
                                    <form id='special_request'>@csrf
                                      <div class="form-group">
                                        ...
                                        <textarea rows='2' type="text" name='name' id='name'
                                          class="form-control"></textarea>
                                      </div>
                                      <div class="form-group">
                                        <label for="formGroupExampleInput2">Phone Number</label>
                                        <textarea rows='2' type="number" name='phone' id='phone'
                                          class="form-control"></textarea>
                                      </div>
                                      <div class="form-group">
                                        ...
                                        <textarea rows='5' type="text" class="form-control" name='description'
                                          id='description'
                                          placeholder="Tell us the description of hostel you want us to get for you"></textarea>
                                      </div>

                                  </div>
                                  <div class="modal-footer">
                                    <button type="submit" id='request' class="btn btn-primary">Make Request</button>
                                  </div>
                                  </form>
                                </div>
                              </div>
              ...
              <div class="grid-item grid-item-bottom-5-1-1">
                <div class="module title-module module-title-163">
                  <div class="title-wrapper">
                    ...
                    <div class="subtitle">Filter property based on price and type.</div>
                  </div>
                </div>
              ...
              <div class="grid-item grid-item-bottom-5-2-1">
                <div class="module module-side_products module-side_products-39">
                  <div class="module-body side-products-blocks">
                    <div class="module-item module-item-1">
                      <h3 class="title module-title">Property Type</h3>
                      <div class="side-products">
                        <div class="product-layout  ">
                          <div class="side-product">
                            <div class="col-md-12">
                              <form method='post' action='{{route("filter_property")}}'>@csrf
                                <input name='school_id' type='hidden' value='{{$school_id}}'>

                                <input type='checkbox' value="Furnitures" name='property[]'> Furnitures
                                <input type='checkbox' value="Electronics" name='property[]'> Electronics
                                <input type='checkbox' value="Kitchen" name='property[]'> Kitchen Utensils
                                <input type='checkbox' value="Decorations" name='property[]'> Decorations
                    ...
                    <div class="grid-items">
                      <div class="grid-item grid-item-1">
                        <div class="module module-newsletter module-newsletter-113">
                          <h3 class="title module-title">Want to start selling on CTHostel?</h3>
                          <div class="module-body">
                            <div class="newsletter-text">You can register today to start selling both new and used
                              hostel materials/properties like furnitures, electronics, house decorations, and kitchen
                              utensils.<br>
                      ...
                      <div class="grid-item grid-item-2">
                               ...
                               <a class='btn btn-success' href='/register' target="_blank">Register Now!</a>
                      ...
                      <li class="menu-item links-menu-item links-menu-item-1">
                        ...
                        <a href='https://thecaretech.org'>
                          <span class="links-text text-center text-blue"
                            style='color:white;text-align:center;float:right'> Developed by <a
                              href='https://thecaretech.org'> CareTech </a> </span></a>
                      </li>
