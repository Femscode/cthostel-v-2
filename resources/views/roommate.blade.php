...
<meta http-equiv="content-type" content="Securing a reliable, comfortable and affordable hostels" /><!-- /Added by HTTrack -->
<meta name="description" content="Securing a reliable, comfortable and affordable hostel" />
                    ...
                    <div class="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1" id="kt_aside_menu_wrapper"
                        ...
                        <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold"
                            ...
                            <div class="menu-item py-2">
                                <a class="menu-link active menu-center" href="/feedback" data-bs-trigger="hover"
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="https://cthostel.com" class="d-lg-none">
                            ...
                            <div class="card-body flex-column p-5">
                                ...
                                <div class="d-flex align-items-center h-lg-300px p-5 p-lg-15">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <h1 class="fw-bolder fs-4 fs-lg-1 text-gray-800 mb-5 mb-lg-10">Get yourself a Room mate of your choice</h1>
                                        <!--end::Title-->
                                        <!--begin::Input group-->
                                    ...
                                    <div class="flex-equal d-flex justify-content-center align-items-end ms-5">
                                        <!--begin::Illustration-->
                                            <img src='/myimages/roommate.png' class="mw-100 mh-125px mh-lg-275px mb-lg-n12">
   
                                   <!--     <img src="{{ asset('backend/media/svg/illustrations/sigma/question.svg') }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-10 p-lg-15">
                                ...
                                <div class="mb-13">
                                    ...
                                    <div class="mb-15">
                                        <!--begin::Title-->
                                        <h4 class="fs-2x text-gray-800 w-bolder mb-6">Latest Roommate Request</h4>
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <a class='btn btn-success' data-bs-toggle="modal" data-bs-target="#kt_modal_new_address">Make Request</a>
                                        <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    <!--begin::Form-->
                                                    <form method='post' id='roommate_request' enctype="multipart/form-data">@csrf
                                                        <!--begin::Modal header-->
                                                            ...
                                                            <div class="scroll-y me-n7 pe-7"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex flex-stack flex-grow-1">
                                                                        ...
                                                                        <div class="fw-bold">
                                                                            ...
                                                                            <div class="fs-6 text-gray-700">Please make sure that this request is real and genuine because adequate actions will be taken upon all request.
                                                                                <a href="#"></a>
                                                                            </div>
                                                                        </div>
                                                                        <!--end::Content-->
                                                                ...
                                                                <div class="row mb-5">
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        <!--end::Label-->
                                                                        <label
                                                                            class="required fs-5 fw-bold mb-2">Phone Number</label>
                                                                        <!--end::Label-->
                                                                        <!--end::Input-->
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        <!--end::Label-->
                                                                        <label
                                                                            class="required fs-5 fw-bold mb-2">Level</label>
                                                                        <!--end::Label-->
                                                                        <!--end::Input-->
                                                                        <select required type="number" id='level' name='level'
                                                                            class="form-control form-control-solid"
                                                                            placeholder="" >
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        <!--end::Label-->
                                                                        <label
                                                                            class="required fs-5 fw-bold mb-2">Gender</label>
                                                                        <!--end::Label-->
                                                                        <!--end::Input-->
                                                                        <select required type="number" id='gender' name='gender'
                                                                            class="form-control form-control-solid"
                                                                            placeholder="" >
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required fs-5 fw-bold mb-2">Department
                                                                        </label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        <!--end::Label-->
                                                                        <label
                                                                            class="required fs-5 fw-bold mb-2">Religion</label>
                                                                        <!--end::Label-->
                                                                        <!--end::Input-->
                                                                        <select required type="number" id='religion' name='religion'
                                                                            class="form-control form-control-solid"
                                                                            placeholder="" >
                                                                            <option value='Christainity'>Christainity</option>
                                                                            <option value='Islamin'>Islamic</option>
                                                                ...
                                                                <div class="d-flex flex-column mb-5 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="required fs-5 fw-bold mb-2">Select Your Hostel</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <select required class="form-control form-control-solid" id='album_id'
                                        ...
                                        <div class="mb-9">
                                            ...
                                            <div class="card card-bordered w-100">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="d-flex align-items-center f">
                                                            ...
                                                            <div class="d-flex flex-column fw-bold fs-5 text-gray-600 text-dark">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <!--begin::Username-->
                                                                    <a href="../../../pages/profile/overview.html" class="text-gray-800 fw-bolder text-hover-primary fs-5 me-3">{{$feedback->name}}</a>
                                                                    <!--end::Username-->
                                                                    <span class="m-0"></span>
                                                                </div>
                                                                <!--end::Text-->
                                                                <!--begin::Date-->
                                                                <span class="text-muted fw-bold fs-6"><b>Hostel Name:</b> {{$feedback->hostel->name}}</span>
                                                                 <span class="text-muted fw-bold fs-6"><b>Level:</b> {{$feedback->level}}<br><b>Gender:</b> {{$feedback->gender}}<br><b>Department:</b> {{$feedback->department}}<br><b>Religion:</b> {{$feedback->religion}}
                                                                 <br><a href='tel:{{$feedback->phone}}' class='btn btn-primary btn-sm'>Call</a>
                                                                 <a href='https://wa.me/234{{substr($feedback->phone,1)}}?text=Hi%2C%20I%20got%20your%20number%20from%20CTHostel.%20I%20am%20also%20in%20need%20of%20room%20mate%20for(%20{{$feedback->hostel->name}}%20)' class='btn btn-info btn-sm'>Message</a>
                                                                <a class='btn btn-success btn-sm' href="{{route('cthostel',[$feedback->hostel->slug,$feedback->hostel->id])}}"">View Hostel</a>
                                                                 </span>
                                                    ...
                                                    <!--end::Wrapper-->
                                                    <!--begin::Desc-->
                                                    <p class="fw-normal fs-5 text-gray-700 m-0">{{$feedback->comment}}.</p>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                    ...
                                    <div class="row g-5 mb-5 mb-lg-15">
										...
										<div class="col-sm-6 pe-lg-10">
											...
											<div class="text-center bg-light card-rounded d-flex flex-column justify-content-center p-10 h-lg-100">
												...
												<!--end::Subtitle-->
												<!--begin::Number-->
												<div class="text-gray-700 fw-bold fs-2">(234) 905-8744-473</div>
												<!--end::Number-->
											</div>
											<!--end::Phone-->
										</div>
										...
										<div class="col-sm-6 ps-lg-10">
											...
											<div class="text-center bg-light card-rounded d-flex flex-column justify-content-center p-10 h-lg-100">
												...
												<!--end::Subtitle-->
												<!--begin::Description-->
												<div class="text-gray-700 fs-3 fw-bold">Abeokuta, Ogun State, Nigeria.</div>
												<!--end::Description-->
											</div>
											<!--end::Address-->
										</div>
