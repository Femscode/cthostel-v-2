                                                                ...
                                                                <div class="module-item module-item-1 swiper-slide">
                                                                    <div class="block-body">
                                                                        ...
                                                                        <div class="block-content block-text">
                                                                            Caretech hostel is a very good platforms to
                                                                            advertise hostels, I was able to get
                                                                            my hostel filled up within a week after
                                                                            upload. I am so grateful for having
                                                                            Caretech Hostel
                                                                        </div>
                                                                        <div class="block-footer">- Sotonwa Boluwatife
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="module-item module-item-2 swiper-slide">
                                                                    <div class="block-body">
                                                                        ...
                                                                        <div class="block-content block-text">
                                                                            ...
                                                                            accordance to the amount I have, and
                                                                            I will get to see all hostels at that
                                                                            price,which give me an opportunity to choose
                                                                            from wide range of options.
                                                                        </div>
                                                                        <div class="block-footer">- Adebanjo Adedamola
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="module-item module-item-4 swiper-slide">
                                                                    <div class="block-body">
                                                                        ...
                                                                        <div class="block-content block-text">
                                                                            ...
                                                                            a short period of time at a very cheap
                                                                            price
                                                                            !</div>
                                                ...
                                                <div class="module module-info_blocks module-info_blocks-86">
                                                    <div class="module-body">
                                                        <div
                                                            ...
                                                            <div class="info-block">
                                                                <div class="info-block-content">
                                                                    <div class="info-block-title">Choose your prefered
                                                                        hostel</div>
                                                                    <div class="info-block-text">Select from a
                                                                        collection of our hostels.
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="info-block">
                                                                <div class="info-block-content">
                                                                    <div class="info-block-title">Contact the agent in
                                                                        charge</div>
                                                                    <div class="info-block-text">Message or call the
                                                                        agent in charge directly</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="info-block">
                                                                <div class="info-block-content">
                                                                    <div class="info-block-title">Make payment and own
                                                                        your room</div>
                                                                    <div class="info-block-text">Make an agreement with
                                                                        the agents, check the hostels out
                        ...
                        <div class="grid-col grid-col-bottom-2-2">
                            ...
                            <a href="#products-61181fcd4109f-tab-4">Specials</a>
                                                ...
                                                <div class="tab-content">
                                                    <div class="module-item module-item-1 tab-pane"
                                                    ...
                                                    <div class="module-item module-item-3 tab-pane active"
                                                        id="products-61181fcd4109f-tab-3">
                                                        <div class="product-grid" id='table_data'>
                                                            @foreach($highest as $album)
                                                                    ...
                                                                    <div class="caption">
                                                                        <div class="stats">
                                                                            <span class="stat-2" style='color:red'><span
                                                                                    class="stats-label text-red"></span><strike>
                                                                                    ₦<span>
                                                                                        {{number_format($album->price +
                                                                                        ($album->price *
                                                                                        0.1))}}</span></strike></span>
                                                                            <span class="stat-2"
                                                                                style='color:green;font-size:18px'><span
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="exampleModalLongTitle">Make Special
                                                                            Request</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form id='special_request'>@csrf
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="formGroupExampleInput">Name</label><br>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="formGroupExampleInput2">Phone
                                                                                    Number</label>
                                                                                <textarea rows='2' type="number"
                                                                                    name='phone' id='phone'
                                                                                    class="form-control"></textarea>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="formGroupExampleInput2">Description</label><br>
                                        ...
                                        <div class="module-item module-item-2">
                                            ...
                                            <div class="side-products">
                                                <div class="product-layout  ">
                                                    <div class="side-product">
                                                        <div class="col-md-12">
                                                            <input required type='number' name='min_price'
                                                                class='form-control'>
                                                        </div>
                                        ...
                                        <div class="module-item module-item-3">
                                            ...
                                            <div class="side-products">
                                                <div class="product-layout  ">
                                                    <div class="side-product">
                                                        <div class="col-md-12">
                                                            <input required type='number' name='max_price'
                                                                class='form-control'>
                                                        </div>
