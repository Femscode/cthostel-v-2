...
<head typeof="og:website">
  ...
  <base />
  <link rel="preload" href="{{asset('catalog/view/theme/journal3/icons/fonts/icomoon6654.woff2?v1')}}" as="font"
    crossorigin>
  ...
  <meta name="twitter:description" content="Check out my new hostels at CTHostel" />
  <script>
  ...
  <link href="https://cthostel.com/myimages/fav.png" src='https://cthostel.com/myimages/fav.png' rel="icon" />
          ...
          <div class="desktop-logo-wrapper">
            <div id="logo">
              <a href="index9328.html?route=common/home">
                <img src="https://cthostel.com/myimages/logo_header.png"
                  srcset="https://cthostel.com/myimages/logo_header.png" width="220" height="63" alt="CTHostel"
                  title="Journal 3 Demo 5" />
              </a>
            </div>
          </div>
                      ...
                      <div class="grid-item grid-item-content-top-1-1-1">
                        <div class="links-menu links-menu-125">
                          <ul class="module-body">
                            ...
                            <li class="menu-item links-menu-item links-menu-item-{{++$i}}">
                              <a href="{{route('locationdisplay',[$location->id])}}">
                                <span class="links-text">{{$location->name}}</span>
                              </a>
                            </li>
                    ...
                    <div class="grid-items">
                      <div class="grid-item grid-item-content-top-1-2-1">
                        <div class="module module-master_slider module-master_slider-232"
                          style="background-image:url('banner/banner1.png')">
                          <div class="journal-loading"><i class="fa fa-spinner fa-spin"></i></div>
                          <img src="/https://cthostel.com/myimages/silder_03.jpg"
                            srcset="https://cthostel.com/myimages/slider_03.jpg" alt="" width="880" height="440" />
                          ...
                          <div class="master-slider ms-skin-minimal"
                            ...
                            <div class="module-item module-item-1 ms-slide" data-delay="2.5">
                              <img src="/https://cthostel.com/myimages/slider_02.jpg"
                                srcset="https://cthostel.com/myimages/slider_02.jpg" alt="" width="880" height="440" />
                            ...
                            <div class="module-item module-item-2 ms-slide" data-delay="2.5">
                              <img src="/https://cthostel.com/myimages/slider_01.jpg"
                                srcset="https://cthostel.com/myimages/slider_01.jpg" alt="" width="880" height="440" />
                              ...
                              <div style='color:#033553'
                                ...
                                data-ease="easeOutQuart" data-hide-effect="fade" data-hide-delay="0"
                                data-hide-duration="0">A Very Liable Hostel With No Stress</div>
                              <div class="module-subitem module-subitem-2 ms-layer ms-layer-text ms-caption"
                                data-resize="true" data-origin="ml" data-parallax="0" data-type="text"
                            ...
                            <div class="module-item module-item-3 ms-slide" data-delay="2.5">
                              <img src="/https://cthostel.com/myimages/slider_03.jpg"
                                srcset="https://cthostel.com/myimages/slider_03.jpg" alt="" width="880" height="440" />
                              ...
                              <div class="module-subitem module-subitem-1 ms-layer ms-layer-text ms-caption"
                                ...
                                data-effect="skewright(60,200)" data-delay="" data-duration="500"
                                data-ease="easeOutQuart" data-hide-effect="fade" data-hide-delay="0"
                                data-hide-duration="0">Get the best hostels from {{$agent->name}}</div>
                              <div class="module-subitem module-subitem-2 ms-layer ms-layer-text ms-caption"
                                data-resize="true" data-origin="ml" data-parallax="0" data-type="text"
                                data-position="normal" data-offset-x="30" data-offset-y="20"
                                data-effect="skewright(60,200)" data-delay="" data-duration="500"
                  ...
                  <div class="module module-info_blocks module-info_blocks-260">
                    <div class="module-body">
                      <div class="module-item module-item-1 info-blocks info-blocks-icon">
                        <div class="info-block">
                          <div class="info-block-content">
                            <div id='latesthostel' class="info-block-title">Hostels by {{$agent->name}}</div>
                      ...
                      <div class="tab-container">
                        <ul class="nav nav-tabs">
                          <li class="tab-1 active">
                            <a href="#products-61181fcd4109f-tab-1" data-toggle="tab">Latest</a>
                          </li>
                        </ul>
                                ...
                                <div class="product-thumb">
                                  ...
                                  <div class="caption">
                                    ...
                                    <div class="name"><a href='{{route("cthostel",[$album->slug,$album->id])}}'
                                        class='btn btn-sm' style='background:#003533;color:white;'>View hostel</a></div>
                                    ...
                                    <div class="extra-group">
                                      <div>
                                        <!--     <a href='{{route("cthostel",[$album->slug,$album->id])}}' class="btn btn-primary ">
                                            <span class="btn btn-success">View Hostel</span>
                                            <input id='getid' type='hidden' value='{{$school_id}}'>
                                          </a>
                                          <a class="btn btn-extra btn-extra-93" href='https://wa.me/234{{substr($album->user->phone,1)}}?text=Hi%2C%20my%20name%20is%20%28Input%20your%20name%29.%20I%20am%20interested%20in%20an%20hostel%20of%20yours%20%28Input%20name%20of%20hostel%29%20%20from%20caretech.'
                                            data-product_id="423"
                                            >
                                            <span class="btn-text">Message Agent</span>
                                          </a>-->
                                      </div>
                                    </div>
                                  </div>
                ...
                <div class="grid-item grid-item-bottom-5-1-1">
                  <div class="module title-module module-title-163">
                    <div class="title-wrapper">
                      ...
                      <div class="subtitle">Filter hostel based on price and locationt.</div>
                    </div>
                  </div>
      ...
      <div class="module module-notification module-notification-137 notification"
        ...
        <div class="notification-content">
          <div>
            ...
            <div class="notification-text">Thanks for coming, you can always check back for latest hostels</div>
          </div>
        </div>
      </div>
    </div>
