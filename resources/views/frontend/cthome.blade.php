                      ...
                      <div class="tab-container">
                        <ul class="nav nav-tabs">
                          <li class="tab-1 active">
                            <a href="/cthome/{{ $school_id }}">Latest</a>
                          </li>
                          <li class="tab-2">
                            <a href="/cheapest/{{ $school_id }}">Cheapest</a>
                          </li>
                          <li class="tab-3">
                            <a href="/bestrated/{{ $school_id }}">Best Rated</a>
                          </li>
                          <!--  <li class="tab-4">
                            <a href="#products-61181fcd4109f-tab-4">Specials</a>
                          </li>-->
                          <li class='tab-5'>
                            <a href="#products-61181fcd4109f-tab-5">Special Request</a>
                          </li>
                        </ul>
