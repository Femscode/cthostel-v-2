...
<head>
    ...
    <title>CTHostel | Technician/Service Registration</title>
    ...
    <div class="auth-container">
        ...
        <div class="auth-showcase">
            ...
            <div class="showcase-content">
                <span class="showcase-tag">Service Portal</span>
                <h1 class="showcase-title">Offer Your Services to Students.</h1>
                <p class="showcase-text">
                    Create an account to join as a verified Technician on CTHostel. Reach thousands of verified students who need utility services and grow your local business.
                </p>
            </div>
        ...
        <div class="auth-form-side">
            <div class="auth-card">
                ...
                <div class="auth-header">
                    ...
                    <p>Create a technician account to offer utility services.</p>
                </div>
                ...
                <form action="{{ route('saveservice') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="type" class="form-label">Service You Render</label>
                        <div class="input-wrapper">
                            <i class="fa-solid fa-tools input-icon"></i>
                            <select id="type" name="type" required class="form-control">
                                <option value=''>Select Service You Render</option>
                                <option value='Cleaning Service' {{ old('type') == 'Cleaning Service' ? 'selected' : '' }}>Cleaning Service</option>
                                <option value='Electrician' {{ old('type') == 'Electrician' ? 'selected' : '' }}>Electrician</option>
                                <option value='Painter' {{ old('type') == 'Painter' ? 'selected' : '' }}>Painter</option>
                                <option value='Plumber' {{ old('type') == 'Plumber' ? 'selected' : '' }}>Plumber</option>
                                <option value='Mechanic' {{ old('type') == 'Mechanic' ? 'selected' : '' }}>Mechanic</option>
                                <option value='A.C Technician' {{ old('type') == 'A.C Technician' ? 'selected' : '' }}>A.C Technician</option>
                                <option value='Phone Engineer' {{ old('type') == 'Phone Engineer' ? 'selected' : '' }}>Phone Engineer</option>
                                <option value='Laptop Engineer' {{ old('type') == 'Laptop Engineer' ? 'selected' : '' }}>Laptop Engineer</option>
                                <option value='Kitchen Appliances Engineer' {{ old('type') == 'Kitchen Appliances Engineer' ? 'selected' : '' }}>Kitchen Appliances Engineer</option>
                                <option value='TV/Playstation Engineer' {{ old('type') == 'TV/Playstation Engineer' ? 'selected' : '' }}>TV/Playstation Engineer</option>
                                <option value='Washing Machine Specialist' {{ old('type') == 'Washing Machine Specialist' ? 'selected' : '' }}>Washing Machine Specialist</option>
                            </select>
                        </div>
                    </div>
