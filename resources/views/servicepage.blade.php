<!DOCTYPE html>
  ...
  <!--Begin::Google Tag Manager -->
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">CTHostel Services</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<div id="kt_account_settings_profile_details" class="collapse show">
										...
										<form id="search_technician" class="form">
											...
											<div class="card-body border-top p-9">
												...
												<div class="row mb-6">
													...
													<div class="col-lg-8 fv-row">
														<select id="school_id" required name="country" aria-label="Select Institution" data-control="select2" data-placeholder="Select your institution..." class="sch_id form-select form-select-solid form-select-lg fw-bold">
												...
												<div class="row mb-6">
													...
													<div class="col-lg-8 fv-row">
														<select  id="school_location" name="location" aria-label="Select Location" data-control="select2" data-placeholder="Select your location..." class="form-select form-select-solid form-select-lg fw-bold">
															<option value="">Select your location...</option>
															<option data-kt-flag="flags/afghanistan.svg" value="AF">Location</option>
														</select>
													</div>
													<!--end::Col-->
												</div>
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <select name="service" aria-label="Select Service" data-control="select2" id='service_type' data-placeholder="Select service..." class="form-select form-select-solid form-select-lg fw-bold">
											...
											<div class="card-footer d-flex justify-content-end py-6 px-9">
												...
												<button type="submit" id='search_btn'  class="btn btn-primary" id="kt_account_profile_details_submit">Search</button>
											</div>
											<!--end::Actions-->
										</form>
										<!--end::Form-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								<li class="menu-item">
									<a href="https://cthostel.com/welcomepage" target="_blank" class="menu-link px-2">About</a>
								</li>
								<li class="menu-item">
    ...
    <script src="{{ asset('assets2/js/custom/intro.js') }}"></script> <script>
